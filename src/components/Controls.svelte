...
<div class="controls">
  ...
  <div class="button-group">
    <button on:click={() => appActions.startRender()} class="primary-button">Start Render</button>
    <button on:click={() => appActions.cancelRender()} class="primary-button">Cancel Render</button>
